    ...
    <>
      <footer className="footer-main">
        <div className="container">
          ...
          <div className="footer-bottom"><span>© 2026 {info.name}. All rights reserved.</span><span>Made with <i className="bi bi-heart-fill" style={{ color: 'var(--primary)', fontSize: '.6rem' }}></i></span></div>
        </div>
      </footer>
