    ...
    <div className="anim d1">
      ...
      <ModalBackdrop show={showModal} onClose={closeModal}>
            ...
            <div className="d-flex gap-3 justify-content-end mt-4">
              ...
              <button onClick={handleSave} style={{ padding: '10px 28px', borderRadius: '12px', border: 'none', background: '#3b82f6', color: '#fff', fontWeight: 700, fontSize: '.88rem', cursor: 'pointer', boxShadow: '0 4px 15px rgba(59,130,246,0.3)' }}><i className="bi bi-save me-2"></i>{editId ? 'บันทึก' : 'เพิ่มบทความ'}</button>
            </div>
      </ModalBackdrop>
    </div>
  );
