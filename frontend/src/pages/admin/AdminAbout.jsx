      ...
      <div className="row g-4">
        ...
        <div className="col-lg-8">
          ...
          <div className="card border-0 shadow-sm rounded-4 mb-4">
            <div className="card-header bg-white border-bottom pt-4 pb-3 px-4">
              <h5 className="fw-bold m-0">ข้อความหลัก (Text & Headers)</h5>
            </div>
          ...
          <div className="card border-0 shadow-sm rounded-4 mb-4">
            <div className="card-header bg-white border-bottom pt-4 pb-3 px-4">
              <h5 className="fw-bold m-0">วิดีโอนำเสนอ (Video Presentation)</h5>
            </div>
            <div className="card-body p-4">
              <div className="row g-4">
                <div className="col-md-6">
          ...
          <div className="card border-0 shadow-sm rounded-4 mb-4">
            <div className="card-header bg-white border-bottom pt-4 pb-3 px-4 d-flex justify-content-between align-items-center">
              <h5 className="fw-bold m-0">ค่านิยม / จุดเด่น (Core Values)</h5>
              <button className="btn btn-sm btn-primary rounded-3" onClick={handleAddCoreValue}><i className="bi bi-plus"></i> เพิ่ม</button>
            </div>
            <div className="card-body p-4">
              {aboutConfig.coreValues.map((cv, idx) => (
                <div key={idx} className="d-flex gap-3 align-items-center mb-3 bg-light p-3 rounded-3 border">
                  <div style={{ width: '150px' }}>
                    <label className="small fw-bold">ไอคอน (Bootstrap Icon)</label>
                    <input type="text" className="form-control form-control-sm" value={cv.icon} onChange={(e) => updateCoreValue(idx, 'icon', e.target.value)} placeholder="bi-heart-fill" />
                  </div>
          ...
          <div className="card border-0 shadow-sm rounded-4 mb-4">
            <div className="card-header bg-white border-bottom pt-4 pb-3 px-4">
              <h5 className="fw-bold m-0">รูปภาพประกอบทีมงาน (ตรงกลางเพจข้างๆ Quote)</h5>
            </div>
            <div className="card-body p-4">
              <div className="row g-4">
                {[0, 1].map(idx => (
          ...
          <div className="card border-0 shadow-sm rounded-4 mb-4">
            <div className="card-header bg-white border-bottom pt-4 pb-3 px-4 d-flex justify-content-between align-items-center">
              <h5 className="fw-bold m-0">แบนเนอร์ด้านล่างสุด (Bottom Banners)</h5>
              <button className="btn btn-sm btn-primary rounded-3" onClick={handleAddBanner}><i className="bi bi-plus"></i> เพิ่มแบนเนอร์</button>
            </div>
            <div className="card-body p-4">
          ...
          <div className="card border-0 shadow-sm rounded-4 mb-4">
            <div className="card-header bg-white border-bottom pt-4 pb-3 px-4 d-flex justify-content-between align-items-center">
              <h5 className="fw-bold m-0">เส้นทางของเรา (Timeline)</h5>
              <button className="btn btn-sm btn-primary rounded-3" onClick={handleAddTimeline}><i className="bi bi-plus"></i> เพิ่มเหตุการณ์</button>
            </div>
            <div className="card-body p-4">
        ...
        <div className="col-lg-4">
          <div className="card border-0 shadow-sm rounded-4 position-sticky" style={{ top: '100px' }}>
            <div className="card-header bg-white border-bottom pt-4 pb-3 px-4 d-flex justify-content-between align-items-center">
              <h5 className="fw-bold m-0">ตัวเลขสถิติ (ลอยบนรูป)</h5>
              <button className="btn btn-sm btn-primary rounded-3" onClick={handleAddStat}><i className="bi bi-plus"></i></button>
            </div>
